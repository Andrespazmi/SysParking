             ...
             <div class="row mt-4">                     
                ...
                <div class="form-group col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        ...
                        <input type="text" wire:model.lazy="nombre"  class="form-control" maxlength="30"  placeholder="ej: Jose Delgado">
                    </div>
                ...
                <div class="form-group col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        ...
                        <input type="text" wire:model.lazy="email" class="form-control"  placeholder="ej: jose.delgado@example.com">
                    </div>
                </div>
