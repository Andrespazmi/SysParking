    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="{{ url('home') }}"><img alt="logo" src="{{ asset('images/syslogo.png') }}"> <span class="navbar-brand-name">SysParking</span></a>
            </div>
 ...
 <div class="main-container" id="container">
    ...
    <li class="menu single-menu">
        ...
        <ul class="collapse submenu list-unstyled" id="forms"  data-parent="#topAccordion">
            <li>
                <a href="{{url('cotizaciones')}}"> HISTORIAL </a>
            </li>
            <li>
